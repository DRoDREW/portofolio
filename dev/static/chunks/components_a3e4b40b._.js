    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ScrollAnimation.useEffect": ()=>{
            const observer = new IntersectionObserver({
                "ScrollAnimation.useEffect": (entries)=>{
                    entries.forEach({
...
_s(ScrollAnimation, "CKe/C9l/PZDcdMrjDfTWxieUegY=");
_c = ScrollAnimation;
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Hero.useEffect": ()=>{
            ...
            const t1 = setInterval({
                "Hero.useEffect.t1": ()=>{
                    setTyped({
                        "Hero.useEffect.t1": (prev)=>prev + welcome[i]
                    }["Hero.useEffect.t1"]);
                    i++;
                    if (i >= welcome.length) clearInterval(t1);
                }
            }["Hero.useEffect.t1"], 40);
            // after welcome typed, type the name and subtitle
            const t2 = setTimeout({
                "Hero.useEffect.t2": ()=>{
                    let j = 0;
                    const nameTimer = setInterval({
                        "Hero.useEffect.t2.nameTimer": ()=>{
                            setSubtitle({
                                "Hero.useEffect.t2.nameTimer": (prev)=>prev + nameLine[j]
                            }["Hero.useEffect.t2.nameTimer"]);
                            j++;
                            if (j >= nameLine.length) {
                                ...
                                const subTimer = setInterval({
                                    "Hero.useEffect.t2.nameTimer.subTimer": ()=>{
                                        setSubtitle({
                                            "Hero.useEffect.t2.nameTimer.subTimer": (prev)=>prev + (k === 0 ? '\n' : '') + subLine[k]
                                        }["Hero.useEffect.t2.nameTimer.subTimer"]);
                                        k++;
                                        if (k >= subLine.length) clearInterval(subTimer);
                                    }
                                }["Hero.useEffect.t2.nameTimer.subTimer"], 20);
                            }
                        }
                    }["Hero.useEffect.t2.nameTimer"], 60);
                }
            }["Hero.useEffect.t2"], welcome.length * 40 + 300);
            return ({
                "Hero.useEffect": ()=>{
                    clearInterval(t1);
                }
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ScrollAnimation$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: subtitle.split('\n').map((line, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
_s(Hero, "1FHPkjYdEzO3afl7YHSs+dg4QuY=");
_c = Hero;
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CustomAlert.useEffect": ()=>{
            if (isVisible) {
                ...
                }["CustomAlert.useEffect.timer"], 3000); // Auto close after 3 seconds
                return ({
...
_s(CustomAlert, "OD7bBpZva5O2jO+Puf00hKivP7c=");
_c = CustomAlert;
...
_s(Contact, "d9XYwR9A0xn09uRBtEhBhtGTO5M=");
_c = Contact;
...
//# sourceMappingURL=components_a3e4b40b._.js.map